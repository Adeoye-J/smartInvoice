...
// import { Loader2, FileTerminal, DollarSign, Plus, FileText } from 'lucide-react'
...
//                 );
//             } catch (error) {
//                 console.error("Failed to fetch dasboard data", error);
//             } finally {
//                 setLoading(false);
//             }
//         };
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-slate-500 mt-2">
                            ${stats.totalReceived.toFixed(2)} received
                        </p>
                    </div>
                </div>
            </div>
