...
import { Loader2, Printer, AlertCircle, ArrowLeft, CheckCircle } from 'lucide-react';
                ...
                <div className="flex justify-end">
                    <div className="w-full max-w-sm space-y-3">
                        ...
                        <div className="bg-green-100 rounded-lg p-4 text-center mt-4">
                            ...
                            <p className="text-3xl font-bold text-green-600">${receipt.amountPaid.toFixed(2)}</p>
                        </div>
                    </div>
                </div>
