...
const Security = () => {
    ...
    const handleExportData = async () => {
        ...
        try {
            ...
            a.href = url;
            a.download = `smartinvoice-data-export-${Date.now()}.json`;
            a.click();
                                    ...
                                    <div className="bg-white border-2 border-blue-200 rounded-lg p-6">
                                        ...
                                        <div className="flex gap-3">
                                            <input
                                                ...
                                                placeholder="000000"
                                                maxLength={6}
                                                className="w-40 px-4 py-2 text-center text-2xl font-mono border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                            />
                                            <Button
                                                variant="primary"
                    ...
                    {activeTab === 'password' && (
                        <div className="space-y-6">
                            <div className="flex items-start gap-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                ...
                                <div>
                                    <h3 className="font-semibold text-blue-900">Password Reset</h3>
                                    <p className="text-sm text-blue-700 mt-1">
