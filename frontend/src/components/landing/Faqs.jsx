        ...
        <section id='faq' className='py-20 lg:py-28 bg-white'>
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <p className='text-xl text-gray-600 max-w-3xl mx-auto'>Here are answers to some of the most common questions our users ask before and after getting started with SmartInvoice+.</p>
                </div>
