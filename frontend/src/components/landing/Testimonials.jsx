        ...
        <section id='testimonials' className='py-20 lg:py-28 bg-white'>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    <h2 className='text-3xl sm:text-4xl font-extrabold text-gray-900 mb-4'>People Who Use SmartInvoice+ Love It</h2>
                    <p className='text-xl text-gray-600 max-w-3xl mx-auto'>See how professionals like you are saving time, staying organized, and getting paid faster with SmartInvoice+.</p>
                </div>
