            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div className="space-y-4 md:col-span-2 lg:col-span-1">
                        <Link to={"/"} className='flex items-center space-x-2 mb-4'>
                            ...
                            <span className='text-xl font-bold'>Smart<span className='text-blue-950 font-extrabold'>Invoice+</span></span>
                        </Link>
                    ...
                    <div className="">
                        ...
                        <ul className='space-y-2'>
                            ...
                            <li>
                                <FooterLink to={"/terma"}>Terms of Service</FooterLink>
                            </li>
                        </ul>
                    </div>
                </div>
                <div className="border-t border-gray-800 py-8 mt-16">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        <p className='text-gray-600'>&copy; 2025 SmartInvoice+. All rights reserved.</p>
