...
// Small example you can copy into App.jsx to test quickly
// export function TooltipExample() {
//   return (
//     <div className="min-h-screen flex items-center justify-center bg-gray-50 p-8">
//       <div className="space-x-6">
//         <Tooltip content={"I am a tooltip on top"} placement="top">
//           <button className="px-4 py-2 rounded bg-blue-600 text-white">Hover me</button>
//         </Tooltip>

//         <Tooltip content={<span>Right side content — <strong>HTML OK</strong></span>} placement="right">
//           <button className="px-4 py-2 rounded bg-emerald-600 text-white">Hover right</button>
//         </Tooltip>

//         <Tooltip content={"Clickable tooltip (toggle)"} showOnClick placement="bottom">
//           <button className="px-4 py-2 rounded bg-orange-500 text-white">Click me</button>
//         </Tooltip>
//       </div>
//     </div>
//   );
