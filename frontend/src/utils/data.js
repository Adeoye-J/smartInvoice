...
export const testimonials = [
  {
    quote:
      "SmartInvoice+ has completely transformed how I manage my business. Creating invoices and receipts is now effortless — I can send documents to clients within minutes.",
  ...
  {
    quote:
      "Before SmartInvoice+, I was juggling multiple tools for billing and receipts. Now, everything is integrated, backed up, and easily accessible — I can’t imagine switching back.",
...
export const faqs = [
  {
    question: "What is SmartInvoice+?",
    answer:
      "SmartInvoice+ is an all-in-one web platform that allows you to create, manage, and store professional invoices and receipts securely in the cloud. It’s designed for freelancers, entrepreneurs, and businesses who want to simplify their billing process.",
  },
  {
    question: "Do I need to install any app to use it?",
    answer:
      "No, you don’t need to install anything. SmartInvoice+ runs entirely online, so you can access your account from any device — desktop, tablet, or smartphone — through your web browser.",
  },
  {
  ...
  {
    question: "Can I use SmartInvoice+ for free?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes, you can select different currencies based on your client’s location. SmartInvoice+ supports multiple currency formats for international invoicing.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "SmartInvoice+ integrates with Paystack and Flutterwave, allowing secure payments through debit/credit cards, bank transfers, and mobile wallets.",
  },
];
